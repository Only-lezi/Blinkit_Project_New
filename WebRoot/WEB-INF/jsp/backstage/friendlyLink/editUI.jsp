...
<div class="am-cf admin-main">
	...
	<div class="admin-content">
		<div class="admin-content-body">
			...
			<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改友情链接 </strong> / <small>Form</small></div>
			</div>
			<hr>
			      	
			<div class="am-panel">
				<form class="am-form" action="${basePath }admin/link/edit.action" method="post" enctype="multipart/form-data">
					<s:hidden name="friendlyLink.linkName"></s:hidden>
					
					<div class="am-g am-margin-top">
						
						<div class="am-u-sm-4 am-u-md-2 am-text-right">网站名称：</div>
						<div class="am-u-sm-8 am-u-md-4">
							<s:textfield class="am-input-sm"  name="friendlyLink.linkName"/>
						</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end" >
							<s:textfield class="am-input-sm"  name="friendlyLink.linkURL"/>
						</div>
						<div class="am-hide-sm-only am-u-md-6">*必填，不可重复</div>
					</div>
