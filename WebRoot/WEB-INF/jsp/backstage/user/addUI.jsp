...
<div class="am-cf admin-main">
	...
	<div class="admin-content">
		<div class="admin-content-body">
			...
			<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加用户</strong> / <small>Form</small></div>
			</div>
			
			<hr>
			      	
			<div class="am-panel">
				<form class="am-form" action="${basePath }admin/user_add.action" method="post" enctype="multipart/form-data">
					<div class="am-g am-margin-top">
						<div class="am-u-sm-4 am-u-md-2 am-text-right">账户：</div>
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" class="am-input-sm" name="userControl.account"/>
						</div>
					...
					<div class="am-g am-margin-top">
						<div class="am-u-sm-4 am-u-md-2 am-text-right">用户名(昵称)：</div>
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end" >
							<input type="text" class="am-input-sm" name="userControl.nickName"/>
						</div>
						<div class="am-hide-sm-only am-u-md-6">*必填，不可重复</div>
					</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" class="am-input-sm" name="userControl.passWord"/>
						</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" class="am-input-sm" name="userControl.userEmail"/>
						</div>
						<div class="am-hide-sm-only am-u-md-6">选填</div>
					</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" class="am-input-sm" name="userControl.userPhone"/>
						</div>
						<div class="am-hide-sm-only am-u-md-6">选填</div>
					</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<s:radio list="#{'1':'有效','0':'无效' }" name="userControl.state" value="1"></s:radio>
							<!-- <input type="text" class="am-input-sm" name="userControl.passWord"/> -->
						</div>
						<div class="am-hide-sm-only am-u-md-6">选填</div>
					</div>
