  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">Blog列表</strong> / <small>Table</small></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            <div class="am-btn-group-xs"><!-- am-btn-group am-btn-group-xs -->
              <a href="${basePath }admin/blog_addUI.action" type="button" class="am-btn am-btn-default" ><span class="am-icon-plus"></span> 新增</a>
              ...
              <tbody>
            	<s:iterator value="userContorlList">
	              <tr>
	                ...
	                <td>头像</td>
	                <td><a href="${basePath }admin/user_editUI.action?userControl.userId=<s:property value='userId'/>"><s:property value="account"/></a></td>
	                ...
	                <td>
	                  <div class="am-btn-toolbar">
	                    <div class="am-btn-group am-btn-group-xs">
	                      <a href="${basePath }admin/user_editUI.action?userControl.userId=<s:property value='userId'/>"  class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
	                      <a href="${basePath }admin/user_delete.action?userControl.userId=<s:property value='userId'/>" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
	                    </div>
	                  </div>
	                </td>
...
<footer>
  ...
  <p class="am-padding-left">© 2014 AllMobilize, Inc. Licensed under MIT license.</p>
	...
	<script type="text/javascript">
		...
		// 新增用户
		function doAdd() {
			document.forms[0].action = "${basePath }admin/blog_addUI.action";
